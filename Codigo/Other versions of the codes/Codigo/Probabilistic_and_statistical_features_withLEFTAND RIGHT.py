...
# Separate the data:
e_p = Pass_epochs_data
e_l = Left_Right_epochs_data

e_p_test = Pass_epochs_data_test
e_l_test = Left_Right_epochs_data_test
...
clf = Pipeline([('scale', scale),('RF', lda)])
...
with open('RightLeft_vs_Pass_Classification.pkl','wb') as f:
    pickle.dump(clf,f)
